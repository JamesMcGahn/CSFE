...
class UnionFind:
    def __init__(self, num_sets: int):
        self.nodes: list[UnionFindNode] = [UnionFindNode(i) for i in range(num_sets)]
        self.set_sizes: list[int] = [1 for i in range(num_sets)]
    ...
    def union_sets(self, label1: int, label2: int) -> None:
